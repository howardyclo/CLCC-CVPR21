...
PRETRAINED_MODEL_PATH = "pretrained_models/imagenet/squeezenet.pkl"
SUBTRACT_IMAGENET_MEAN = False # Subraction will not preserve original illuminant label.
...
def backbone(images):
    return SqueezeNet(images).get_features_out()